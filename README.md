...
###[View Live Rockjins Blog &rarr;](https://huangxuan.me)
...
```
# Site settings
title: Rockjins Blog             # title of your website
SEOTitle: Rockjins Blog			# check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Rockjins Blog”** but I want the title shows in search engine is **“黄玄的博客 | Rockjins Blog”** which is multi-language.
...
Rockjins Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
